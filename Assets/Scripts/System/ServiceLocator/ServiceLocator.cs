...
using Object = UnityEngine.Object;
    public class ServiceLocator : MonoBehaviour {
        ...
        {
            //Parent Hierarchy -> Scene -> Global
            ServiceLocator container = mb.GetComponentInParent<ServiceLocator>().OrNull() ?? ForSceneOf(mb) ?? Global;
            return container;
        }
        ...
        {
            _services.Register(service.GetType(), service);
            return this;
        }
        ...
        bool TryGetNextInHierarchy(out ServiceLocator container) {
            ...
            // Travel from parent to scene to find Service Locator instance
        ...
        static void AddGlobal() {
            var go = new GameObject(GLOBAL_SERVICE_LOCATOR_NAME, typeof(GlobalServiceBootstrapper));
        }
        
        [MenuItem("GameObject/ServiceLocator/Add Scene ServiceLocator")]
        static void AddScene() {
            var go = new GameObject(SCENE_SERVICE_LOCATOR_NAME, typeof(SceneServiceBootstrapper));
        }
#endif
    }
}